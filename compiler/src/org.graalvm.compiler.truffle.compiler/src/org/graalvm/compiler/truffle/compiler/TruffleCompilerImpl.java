...
public abstract class TruffleCompilerImpl implements TruffleCompilerBase {
    ...
    public CompilationResult compilePEGraph(StructuredGraph graph,
        ...
        try (DebugCloseable a = CompilationTime.start(debug);
            ...
            TornadoVMCompiler.compileGraph(graph, graph.method(), selectedProviders, tier.backend(), graphBuilderSuite, Optimizations, graph.getProfilingInfo(), selectedSuites, selectedLirSuites, compilationResult, CompilationResultBuilderFactory.Default, false);
